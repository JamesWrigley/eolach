...
deploy: bundle frontend/index.html frontend/cognito.js frontend/Api.template.elm
	terraform apply
	...
	aws s3 mv ./frontend/index.html s3://`terraform output frontend_s3_bucket` --content-type 'text/html'
	aws s3 mv ./frontend/elm.min.js s3://`terraform output frontend_s3_bucket` --content-type 'text/javascript'
	aws s3 mv ./frontend/eolach.js s3://`terraform output frontend_s3_bucket` --content-type 'text/javascript'
