...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Jul 29 23:17:33 2014
# Project:  eolach.pro
# Template: app
...
SOURCES       = KeysWidget.cpp \
		main.cpp \
		MainWindow.cpp moc_KeysWidget.cpp \
		moc_MainWindow.cpp
OBJECTS       = KeysWidget.o \
		main.o \
		MainWindow.o \
		moc_KeysWidget.o \
		moc_MainWindow.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/eolach1.0.0/ && $(COPY_FILE) --parents KeysWidget.h MainWindow.h .tmp/eolach1.0.0/ && $(COPY_FILE) --parents KeysWidget.cpp main.cpp MainWindow.cpp .tmp/eolach1.0.0/ && (cd `dirname .tmp/eolach1.0.0` && $(TAR) eolach1.0.0.tar eolach1.0.0 && $(COMPRESS) eolach1.0.0.tar) && $(MOVE) `dirname .tmp/eolach1.0.0`/eolach1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/eolach1.0.0
...
compiler_moc_header_make_all: moc_KeysWidget.cpp moc_MainWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_KeysWidget.cpp moc_MainWindow.cpp
moc_KeysWidget.cpp: KeysWidget.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) KeysWidget.h -o moc_KeysWidget.cpp
...
KeysWidget.o: KeysWidget.cpp KeysWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o KeysWidget.o KeysWidget.cpp
